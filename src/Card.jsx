...
export default function Card(props) {
    ...
    return (
        <div>
            <div className="relative mx-auto lg:h-[25rem] h-[15rem] w-screen p-7 rounded-lg bg-slate-800 border border-solid border-l-zinc-500 hover:bg-slate-900" style={{ backgroundImage: 'url('+props.img+')',}}>
